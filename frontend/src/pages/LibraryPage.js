    ...
    <div className="flex flex-col h-full" data-testid="library-page">
      <div className="h-14 border-b border-[#E2E8F0] px-6 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-base font-semibold text-[#1A1A2E]">Library</h1>
          <span className="text-xs text-[#64748B] font-mono ml-2">{items.length} items</span>
        </div>
        <button
          onClick={() => setShowForm(!showForm)}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1A1A2E] text-white text-xs font-medium rounded-sm hover:bg-[#0D0D0D] transition-colors"
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[10px] font-mono text-[#64748B] bg-[#F1F5F9] px-1.5 py-0.5 rounded-sm">{item.item_type}</span>
                      {item.tags?.map((tag, i) => (
                  ...
                  <button
                    ...
                    className="text-[#CBD5E1] hover:text-[#991B1B] transition-colors"
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {showForm ? (
            <div className="max-w-lg">
              <h2 className="text-lg font-semibold text-[#1A1A2E] mb-4">Add to Library</h2>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-[#E2E8F0] rounded-sm px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#0D0D0D] min-h-[200px]"
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-[#1A1A2E] text-white px-4 py-2 rounded-sm text-sm font-medium hover:bg-[#0D0D0D] transition-colors"
                  ...
                  <button
                    ...
                    className="border border-[#E2E8F0] px-4 py-2 rounded-sm text-sm text-[#4A4A4A] hover:bg-[#F8FAFC] transition-colors"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div>
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-xs font-mono text-[#64748B] bg-[#F1F5F9] px-2 py-0.5 rounded-sm">{selectedItem.item_type}</span>
              ...
              <div className="border border-[#E2E8F0] rounded-sm p-6 bg-white whitespace-pre-wrap text-[15px] leading-7 text-[#0D0D0D]">
